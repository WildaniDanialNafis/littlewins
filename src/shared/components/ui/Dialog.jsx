...
const VARIANT_CLASSES = {
  ...
  success: [
    ...
    "active:bg-success-active active:scale-[0.98]",
  ...
  warning: [
    ...
    "active:bg-warning-active active:scale-[0.98]",
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col-reverse gap-2.5 sm:flex-row sm:justify-end">
          <button
            ...
            className={cx(CANCEL_BUTTON_CLASS, "w-full sm:w-auto sm:min-w-24")}
          >
            {cancelText}
          </button>
